...
object IconsTwinkleShadowThemed {

    fun getIconId(weatherCode: WeatherCode, isDay: Boolean): Int {
        return when (weatherCode) {
            WeatherCode.CLEAR_SKY ->
                if (isDay) R.drawable.w_0d
                else R.drawable.w_0n

            WeatherCode.MAINLY_CLEAR ->
                if (isDay) R.drawable.w_1d
                else R.drawable.w_1n

            WeatherCode.PARTLY_CLOUDY ->
                if (isDay) R.drawable.w_2d
                else R.drawable.w_2n

            WeatherCode.MOSTLY_CLOUDY ->
                if (isDay) R.drawable.w_3d
                else R.drawable.w_3n
            ...
            WeatherCode.LIGHT_RAIN_SHOWERS_AND_SKY ->
                if (isDay) R.drawable.w_80d
                else R.drawable.w_80n
            ...
            WeatherCode.RAIN_SHOWERS_AND_SKY ->
                if (isDay) R.drawable.w_81d
                else R.drawable.w_81n
            ...
            WeatherCode.HEAVY_RAIN_SHOWERS_AND_SKY ->
                if (isDay) R.drawable.w_82d
                else R.drawable.w_82n
            ...
            WeatherCode.LIGHT_SNOW_SHOWERS_AND_SKY ->
                if (isDay) R.drawable.w_85d
                else R.drawable.w_85n

            WeatherCode.SNOW ->
                R.drawable.w_73

            WeatherCode.SNOW_AND_SKY ->
                if (isDay) R.drawable.w_86d
                else R.drawable.w_86n
            ...
            WeatherCode.HEAVY_SNOW_SHOWERS_AND_SKY ->
                if (isDay) R.drawable.w_87d
                else R.drawable.w_87n
            ...
            WeatherCode.THUNDERSTORM_AND_SKY ->
                if (isDay) R.drawable.w_95d
                else R.drawable.w_95n
