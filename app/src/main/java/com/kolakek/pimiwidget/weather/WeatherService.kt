...
object WeatherService {
    ...
    private fun mapProviderData(providerData: ProviderData, place: String): WeatherData {
        ...
        return WeatherData(
            ...
            hourlyRainMm = providerData.hourly.rain,
            ...
            dailyRainMm = providerData.daily.rain_sum,
            dailyShowersMm = providerData.daily.showers_sum,
            dailySnowCm = providerData.daily.snowfall_sum,
            dailyHumidityMean = providerData.daily.relative_humidity_2m_mean,
            dailyUvIndexMax = providerData.daily.uv_index_max,
            dailySunriseMillis = providerData.daily.sunrise.map { v -> v.toLong() * 1000L },
            dailySunsetMillis = providerData.daily.sunset.map { v -> v.toLong() * 1000L },
